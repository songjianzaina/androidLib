...
/**
 * 该Activity是专门为cloudpay定制的 Activity ,后期可以直接删除 替换成BankQuickActivity即可
 */
public class BankQuickActivity_cloud extends UIActivity {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                convertView = View.inflate(BankQuickActivity_cloud.this,
            ...
            //加载银行图标
            Drawable drawable = mContext.getResources().getDrawable(friend.getIcon());
            // 这一步必须要做,否则不会显示.
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //跳转至银行选择界面
                    //隐式跳转
                    ActivityUtil.startActivity("cloudpay.action.cardedit");
                }
            });
            return convertView;
        }
