...
import com.wintone.OnBankScannerResultListener;
...
public class ScanCamera extends Activity implements Callback, PreviewCallback {
    ...
    private static OnBankScannerResultListener listener;
    ...
    public static void setOnBankScannerResultListener(OnBankScannerResultListener listener) {

        ScanCamera.listener = listener;
    }
...
//                startActivity(intent);
                //扫描结果回调
                if (listener!=null) {
                    listener.onResult(pLineWarp,recogval,String.valueOf(recogval));
                }
