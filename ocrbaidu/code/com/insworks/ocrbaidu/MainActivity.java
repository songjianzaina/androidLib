...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ocr_baidu_activity_main);
        ...
        findViewById(R.id.credit_card_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(intent, REQUEST_CODE_CAMERA);
                //另一种方式
//                EasyIdentify.init(MainActivity.this).openBankOCR(new OnBankIdentifyListener() {
//                    @Override
//                    public void onSuccess(String cardNumber, String cardType, String bank) {
//                        Toast.makeText(MainActivity.this, cardNumber, Toast.LENGTH_SHORT).show();
//                    }
//
//                    @Override
